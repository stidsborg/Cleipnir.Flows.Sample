...
namespace Cleipnir.Flows.Sample.Flows.Ordering.MessageDriven.FlowWithErrorHandling;

[GenerateFlows]
public class MessageDrivenOrderFlowWithErrorHandling(IBus bus) : Flow<Order>
{
